...
enum error {
  ...
  EREAD_DADDR = 0x2000000000,
  EREAD_SADDR = 0x4000000000,
  EREAD_SOCK_PROTOCOL = 0x8000000000,
  EREAD_SOCK_TYPE = 0x10000000000,
  EREAD_SOCK_STATE = 0x20000000000,
  EREAD_DPORT = 0x40000000000,
  EREAD_SPORT = 0x80000000000,
  EFILL_SOCK4 = 0x100000000000,
  EFILL_SOCK6 = 0x200000000000,
  EFILL_SOCK = 0x400000000000,
};
